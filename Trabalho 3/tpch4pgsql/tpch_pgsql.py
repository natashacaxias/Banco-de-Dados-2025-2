...
def main(phase, host="localhost", port=5432, user="postgres", password="test123", 
         database="tpch", dbgen_dir="./tpch-dbgen", data_dir="./data", 
         query_root="./query_root", scale=1.0, num_streams=0, verbose=False, read_only=False):
    ...
    :return: no return value, uses sys.exit(1) if something goes wrong
    """
